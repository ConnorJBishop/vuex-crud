...
var createActions = function createActions(_ref) {
  var actions = _ref.actions,
      ...
      onBatchUpdateStart = _ref.onBatchUpdateStart,
      onBatchUpdateSuccess = _ref.onBatchUpdateSuccess,
      onBatchUpdateError = _ref.onBatchUpdateError,
  ...
  if (only.includes(BATCH_UPDATE)) {
    Object.assign(crudActions, {
       ...
       */
      batchUpdate: function batchUpdate(_ref11) {
  ...
  if (only.includes(REPLACE)) {
    Object.assign(crudActions, {
       ...
       * Update a single resource.
       */
      replace: function replace(_ref13) {
