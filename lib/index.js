...
var createCrud = function createCrud() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      _ref$onBatchUpdateSta = _ref.onBatchUpdateStart,
      onBatchUpdateStart = _ref$onBatchUpdateSta === undefined ? function () {} : _ref$onBatchUpdateSta,
      _ref$onBatchUpdateSuc = _ref.onBatchUpdateSuccess,
      onBatchUpdateSuccess = _ref$onBatchUpdateSuc === undefined ? function () {} : _ref$onBatchUpdateSuc,
      _ref$onBatchUpdateErr = _ref.onBatchUpdateError,
      onBatchUpdateError = _ref$onBatchUpdateErr === undefined ? function () {} : _ref$onBatchUpdateErr,
      ...
      _ref$only = _ref.only,
      only = _ref$only === undefined ? ['FETCH_LIST', 'FETCH_SINGLE', 'CREATE', 'UPDATE', 'BATCH_UPDATE', 'REPLACE', 'DESTROY'] : _ref$only,
  ...
  return {
    ...
    actions: (0, _createActions2.default)({
      ...
      onBatchUpdateStart: onBatchUpdateStart,
      onBatchUpdateSuccess: onBatchUpdateSuccess,
      onBatchUpdateError: onBatchUpdateError,
